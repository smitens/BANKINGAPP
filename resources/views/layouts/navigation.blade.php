<aside class="w-64 bg-gray-800 text-white h-full">
    <div class="p-6">
        ...
        <nav>
            <ul>
                <!-- Sidebar Links -->
                <li><a href="{{ route('dashboard') }}" class="block py-2 px-4 hover:bg-gray-700">{{ __('Dashboard') }}</a></li>
                <li><a href="{{ route('profile.edit') }}" class="block py-2 px-4 hover:bg-gray-700">{{ __('Profile') }}</a></li>
                <!-- Add or remove more links as needed -->
            </ul>
        </nav>
